...
function Animation(_sprite_index = noone, _x = 0, _y = 0, _image_index = 0, _image_speed = 1, _endaction = animation_endaction.loop) constructor
{
	...
	{			
		...
		if (image_index >= image_number and image_speed > 0)
		{
			if (parent != noone)
			{
